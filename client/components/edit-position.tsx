...
import { editPosition } from '../lib/admin'
...
export default function EditPosition({ position }) {
  ...
  const handleSubmit = useCallback(
    ...
    [position.id, description, markdownContent, formAction],
  )
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      name="worktype"
                      defaultValue={position.worktype || ''}
                      required
                    >
            ...
            <CardFooter className="flex justify-between">
              ...
              >
                {pending ? (
                  ...
                  <>
                    <Save className="mr-2 h-4 w-4" /> Edit Position
                  </>
                )}
              </Button>
            </CardFooter>
